...
class Header extends React.Component {
  ...
  render() {
    const { projectTree, clubs: endemicMenu, endemic: selectEndemic, userInfo, selectIndex, messageNum } = this.props;
      ...
      <header className="yt-admin-framework-header clearfix">
        ...
        <Dropdown overlay={ this.userMenu } placement="bottomCenter" trigger={ ['click'] }>
          <div className="header-menu-name">
            ...
            {
              parseInt(messageNum) > 0 && <div className="messageNum">
                <h3 >{messageNum}</h3>
              </div>
            }
