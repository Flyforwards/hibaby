        ...
        <div className="viewTheInformation">
          ...
          <div className="entryInformation">入职信息</div>
            <div className="entryInformationContent">
              <p className="localCenter"><span>地方中心:</span><span className="Two">{entrys.endemicId}</span></p>
              <p className="affiliatedDepartment"><span>隶属部门:</span><span className="Two">{entrys.deptId}</span></p>
              <p className="directLeadership"><span>直系领导:</span><span className="Two">{entrys.leaderId}</span></p>
              <p className="position"><span>职位:</span><span className="Two">{entrys.positionId}</span></p>
          ...
          <div className="contactInformationContent">
              ...
              <p className="affiliatedDepartment"><span>联系方式:</span><span className="Two">{entrys.contact}</span></p>
              <p className="directLeadership"><span>公司邮箱:</span><span className="Two">{entrys.emaill}</span></p>
              <p className="position"><span>内部分机:</span><span className="Two">{entrys.extension}</span></p>
          </div>

          <Button  className="disabledButton" onClick={this.headelDisabled}>禁用</Button>
          <Link to={{ pathname: '/system/organization/editUser', query: { data:dataID } }}><Button  type="primary" className="editButton">编辑</Button></Link>
