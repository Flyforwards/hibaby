    ...
    <div className="healthContentDiv">
      <Form>
        ...
        <Row  className="firstItem" key="3">
          ...
          <Col span="22">
            <Row className="topRightItemBg" style={{minHeight: '110px'}}>
              <Col span="12">
                <div>
                  {myRadioForm(radioNames[6],{title: '乙肝病毒感染或携带',radioItems: ['否','大三阳','小三阳','单纯表面抗原阳性'],value:healthInfo['radio_6'],radioChangeFun:radioChangeFun5})}
                </div>
              </Col>
              <Col span="12">
        ...
        <Row className="firstItem">
          ...
          <Col span="22">
            {radioAllRow(radioNames[15],{title: '分娩方式',radioItems: ['自然分娩','剖宫产'],value:healthInfo['radio_15'],radioChangeFun:radioChangeFMTypeFun})}
        ...
        <Row className="firstItem">
          ...
          <Col span="22">
            ...
            {radioAllRow2(radioNames[24],{title: '腹部伤口',radioItems: ['正常','敷料覆盖未见渗出物','红肿','裂开','感染','无'],value:healthInfo['radio_24']})}
