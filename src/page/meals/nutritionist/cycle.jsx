...
class HeaderDateTabs extends Component {
  ...
  nextDateComponent() {
    ...
    setTimeout(function(){
      let index = Number(this.state.curTabsIndex);
      index += 1;
      this.setState ({
          curTabsIndex: index.toString()
        }
      )
    }.bind(that), 450);
  }
    ...
    return (
      <div className="cycle-tabs">
        <Tabs defaultActiveKey='1'
              activeKey={this.state.curTabsIndex}
              onPrevClick={this.prevDateComponent.bind(this)}
              onNextClick={this.nextDateComponent.bind(this)}
        >
...
function itemCardComponent(dict) {

  // onClick={handleDetail}

  return (
    <div>
      <Card title="周期一" bordered={true} style={{marginBottom: '20px'}}>
        <Row>
...
// 主页面
class MealCycle extends Component {
  ...
  render () {
    return (
      <div className="MealCycle">
        { this.state.isShowDetail ?  '' :headerComponent()}
      </div>
