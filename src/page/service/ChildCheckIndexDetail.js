...
// 新生儿情况
    const newbornTwoAry = [
      ...
      {title:'吐奶',formItems:'TwoWords',span:12,component:'InputGroup',placeholder:'吐奶性状和颜色',submitStr:'babyCare7',radioAry:[{'name':'无','value':'0'},{'name':'有','value':'1'}]},
      ...
      {title:'拥抱反射',formItems:'FourWords',span:12,component:'RadioClass',submitStr:'babyCare11',radioAry:[{'name':'正常','value':'0'},{'name':'异常','value':'1','Element':'Input','submitStr':'babyCare11-0'}]},
      {title:'踏步反射',formItems:'FourWords',span:12,component:'RadioClass',submitStr:'babyCare12',radioAry:[{'name':'正常','value':'0'},{'name':'异常','value':'1','Element':'Input','submitStr':'babyCare12-0'}]},
      {title:'吸允反应',formItems:'FourWords',span:12,component:'RadioClass',submitStr:'babyCare13',radioAry:[{'name':'正常','value':'0'},{'name':'异常','value':'1','Element':'Input','submitStr':'babyCare13-0'}]},
