...
class Detail extends Component {
  ...
  onDelete() {
    this.props.dispatch({
      ...
      payload: { type: type, dataId: this.props.CheckInID }
    })
  }
  ...
  render() {
    ...
    const baseInfoAry = [
      ...
      },
      {
        title: '剖宫产手术指征',
        component: 'Input',
        submitStr: 'health_1_input_5',
        hide: this.state.shoushuHide,
        noRequired: this.state.shoushuHide
      },
      {
        title: '侧切',
        ...
        key: 'radio_15_1_cq',
        hide: this.state.zrfmHide,
        noRequired: this.state.zrfmHide
      },
      ...
      { title: '产后出血', component: 'InputGroup', unit: 'ml', submitStr: 'health_1_input_9' },
      {
        title: '处理措施',
        component: 'RadioGroups',
        radioAry: [{ 'name': '宫缩剂', 'value': '0' }, { 'name': '填宫纱', 'value': '1' }],
        submitStr: 'baseInfo2'
      },
    ...
    const PostpartumSituationAry = [
      ...
      { title: '添加配方奶', component: 'InputGroup', submitStr: 'postpartum_2' },
      {
        ...
        checkAry: ['纯母乳', '混合', '人工'],
        submitStr: 'health_1_radio_33',
        fun: this.handleWYFSChangeFun.bind(this)
      },
      { title: '原因', component: 'Input', submitStr: 'postpartum_3', noRequired: this.state.wyfsReasonHide },
      {
        title: '哺乳问题',
        component: 'CheckBoxGroup',
        checkAry: ['无', '有', '乳头错觉', '疼痛', '乳房肿胀', '乳汁少', '乳汁多', '其他'],
        submitStr: 'postpartum_4',
        span: 24
      }
    ]
    ...
    const checkInMedical = [
      ...
      { title: '现体重', component: 'Input', unit: 'kg', submitStr: 'health_2_input_3' },
      {
        title: '精神状态',
        component: 'CheckBoxGroup',
        checkAry: ['良好', '一般', '淡漠', '疲乏', '焦虑', '烦躁', '抑郁', '其他'],
        submitStr: 'medical_2',
        span: 24
      },
      ...
      { title: '宫底高度', component: 'Input', submitStr: 'medical_11' },
      {
        title: '子宫收缩',
        component: 'RadioGroups',
        radioAry: [{ 'name': '软', 'value': '0' }, { 'name': '硬', 'value': '1' }],
        submitStr: 'medical_12'
      },
      {
        title: '会阴伤口愈合',
        component: 'RadioGroups',
        radioAry: [{ 'name': '良好', 'value': '0' }, { 'name': '水肿', 'value': '1' }, {
          'name': '血肿',
          'value': '2'
        }, { 'name': '裂开', 'value': '3' }, { 'name': '感染', 'value': '4' }, { 'name': '无', 'value': '5' }],
        submitStr: 'health_1_radio_24',
        span: 24
      },
      {
        title: '腹部伤口愈合',
        component: 'RadioGroups',
        radioAry: [{ 'name': '良好', 'value': '6' }, { 'name': '敷料覆盖未见渗出物', 'value': '7' }, {
          'name': '红肿',
          'value': '8'
        }, { 'name': '裂开', 'value': '9' }, { 'name': '感染', 'value': '10' }, { 'name': '无', 'value': '11' }],
        submitStr: 'health_1_radio_24',
        key: 'radio_24_1',
        span: 24
      },
    ...
    const ary = [{ title: summary ? '' : '基本信息', ary: summary ? baseInfoAry.slice(6) : baseInfoAry }, {
      title: '产后情况',
      ary: PostpartumSituationAry
    }, { title: '入所查体', ary: checkInMedical }, { title: '评估结论', ary: conclusionAry }]
        ...
        { CheckInData ?
          <Row style={{ height: '40px' }}>
            <Col offset={12} span={12}>
              {chiDetailComponent([{ title: '评估者', initValue: CheckInData.operator, colSpan: 12 }, {
                title: "评估时间",
                initValue: CheckInData.operatorTime,
                colSpan: 12
              }])}
            </Col>
